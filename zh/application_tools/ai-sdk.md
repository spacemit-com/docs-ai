...
gateway 是统一服务接入层，包含 Python 服务、HTTP/WS API、前端控制台与 Debian 打包流程，不建议简单等同为一个 `mm` 编译的算法组件。gateway 的安装与启动方式见 [第 4 章](#4-gateway-统一-httpws-接入层)。
...
- [model_zoo_voiceprint/README.md](https://github.com/spacemit-com/model_zoo_voiceprint/blob/main/README.md)（声纹识别示例与性能相关参数）
- [model_zoo_rl/README.md](https://github.com/spacemit-com/model_zoo_rl/blob/main/README.md)（策略推理基准测试）
- [ai-gateway/README.md](https://github.com/spacemit-com/ai-gateway/blob/main/README.md)（服务化部署、接口验证与运行状态）
